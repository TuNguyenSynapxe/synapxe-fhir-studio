...
## 1. Purpose
Implement Phase 1 functionality for **mapping-service** using .NET 8 and OpenAPI contract.
...
- Implement endpoints exactly as defined in openapi/mapping-service.openapi.yaml
...
**Prompt 1:**  
"Using openapi/mapping-service.openapi.yaml, generate controller, models, and DI setup."

**Prompt 2:**  
"Create integration tests for all endpoints in mapping-service."
